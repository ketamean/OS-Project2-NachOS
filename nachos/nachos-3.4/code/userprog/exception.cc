	...
	switch (which) {
		...
		case SyscallException:
			switch(type) {
				...
				case SC_ReadInt: 
			{
					handle_SC_ReadInt(); break;
			}	
				case SC_PrintInt:
			{
					handle_SC_PrintInt();break;
			}
				case SC_ReadFloat:
			{
					handle_SC_ReadFloat();break;
			}
				case SC_PrintFloat:
			{
					handle_SC_PrintFloat();break;
			}
				case SC_ReadChar:
			{
					handle_SC_ReadChar();break;
			}
				case SC_PrintChar:
			{
					handle_SC_PrintChar();break;
			}
				case SC_ReadString:
			{
					handle_SC_ReadString();break;
			}
				case SC_PrintString:
			{
					handle_SC_PrintString();break;	
			}	
