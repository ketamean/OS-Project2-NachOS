...
void WriteF(char *buffer, int size, OpenFileId id);
...
/* THIS IS THE START OF THE NEW FUNCTIONS */

/* Uses SynchConsole to read ONE user input integers (if != type(interger) return 0) */
int ReadInt();

/* Uses SynchConsole to print out ONE interger */
void PrintInt(int number);

/* Uses SynchConsole to read ONE user input float (if != type(float) return 0.0) */
float ReadFloat();

/* Uses SynchConsole to print out ONE float */
void PrintFloat(float number);

/* Uses SynchConsole to read ONE user input char */
char ReadChar();

/* Uses SynchConsole to print out ONE char */
