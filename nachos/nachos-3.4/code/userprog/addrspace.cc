...
AddrSpace::AddrSpace(OpenFile *executable)
{
	...
	pageTable[i].physicalPage = gPhysPageBitMap->FindFreeSlot();
    ...
    // bzero isn't needed here, because we call ReadAt and we don't need to zero out the memory, we just need to load the program into memory
